module github.com/Moonlighting-Industries/aws-otel-collector

go 1.21.1

require (
	github.com/Moonlighting-Industries/moon_telemetry/extension/iotauthextension v0.0.0-20231004140404-bf5476aab2e8
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/iot v1.39.5 // indirect
